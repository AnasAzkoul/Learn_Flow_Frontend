...
<template>
  <section class="relative py-16 md:py-20 px-6 md:px-10 bg-bg overflow-hidden">
    <!-- Ambient glow (softened for light bg) -->
    <div
      aria-hidden="true"
      class="absolute pointer-events-none"
      style="top: -30%; left: 20%; width: 70%; height: 80%; background: radial-gradient(ellipse at center, rgba(232, 87, 26, 0.06) 0%, transparent 65%)"
    />
    <!-- Dot grid (light variant) -->
    <div aria-hidden="true" class="absolute inset-0 dot-grid pointer-events-none" />
    ...
    <div class="relative max-w-[1400px] mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-8 md:gap-[60px] items-end mb-10">
        <div>
          ...
          <h2 class="text-text-main" style="font-family: var(--font-display); font-size: clamp(2.25rem, 5vw, 3.75rem); font-weight: 700; line-height: 1.0; letter-spacing: -0.04em">
            How LearnFlow<br />
            <em class="text-primary not-italic" style="font-family: var(--font-sans); font-style: italic; font-weight: 500">Adapts to you.</em>
          </h2>
        </div>
        <div>
          <p class="text-text-sec text-base leading-relaxed max-w-[460px]" style="font-family: var(--font-sans)">
        ...
        <div
          ...
          :style="{
            background: active === 0
              ? 'var(--esp-900)'
              : 'var(--esp-800)',
            border: `1px solid ${active === 0 ? 'rgba(232, 87, 26, 0.35)' : 'var(--esp-700)'}`,
            boxShadow: active === 0
        ...
        <div
          ...
          :style="{
            background: active === i + 1
              ? 'var(--esp-900)'
              : 'var(--esp-800)',
            border: `1px solid ${active === i + 1 ? 'rgba(232, 87, 26, 0.35)' : 'var(--esp-700)'}`,
